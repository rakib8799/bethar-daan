...
$sql=mysqli_query($con,"Update nurses set specilization='$specialization',nurseName='$nurseName',contactno='$contactno' where id='".$_SESSION['id']."'");
if($sql)
{
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									...
									<?php 
$nid=$_SESSION['id'];
$sql=mysqli_query($con,"select * from nurses where id='$nid'");
