...
$nid=intval($_GET['id']);// get nurse id
...
$sql=mysqli_query($con,"Update nurses set specilization='$specialization',nurseName='$nurseName', gender='$gender','contactno='$contactno',nurseEmail='$nurseEmail'  where id='$nid'");
if($sql)
{
...
<?php if($msg) { echo htmlentities($msg);}?> </h5>
									...
									<?php $sql=mysqli_query($con,"select * from nurses where id='$nid'");
while($data=mysqli_fetch_array($sql))
{
?>
<h4><?php echo htmlentities($data['nurseName']);?>'s Profile</h4>
...
<hr />
													<form role="form" name="adddoc" method="post" onSubmit="return valid();">
														<div class="form-group">
															<label for="nurseSpecialization">
																Nurse Specialization
															</label>
							<select name="nursespecialization" class="form-control" required="required">
