				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Doctor | Assign Bed to Patient</h1></br>
									<h4 class ="subTitle"> <font color ="red"> For assigning bed Please go to the navigation patient section and see the patient assign bed history </font>	</h4> 
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Doctor</span>
