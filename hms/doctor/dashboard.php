...
<!----------------------------------------------------------------------my work----------------------------------->
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-paperclip fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Presciption</h2>
										
											<p class="cl-effect-1">
												<!-- <a href="appointment-history.php"> -->
												<!-- <a href="./notice_presciption/index.php"> -->
												<a href="./notice_presciption/hello.html">
													Write prescription
												</a>
											</p>
										</div>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										...
										<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-bed fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Assign Bed</h2>
									...
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle"> View medical History</h2>
										...
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-bed fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Issue Beds</h2>
