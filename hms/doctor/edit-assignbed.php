...
$sql=mysqli_query($con,"Update assignBed set bedNum='$bedNum',patientName='$patientName', gender='$gender','contactno='$contactno' where id='$nid'");
if($sql)
{
...
<?php if($msg) { echo htmlentities($msg);}?> </h5>
									...
									<?php $sql=mysqli_query($con,"select * from assignBed where id='$nid'");
