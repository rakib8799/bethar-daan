...
if(isset($_GET['del']))
		  ...
		  else if(isset($_POST['accept']))
		  {
			  ...
			  echo $uid;
			  $login_status = 1;
			  $sql=mysqli_query($con,"Update users set login_status='$login_status' where id='".$uid."'");
			  if($sql){
			  $_SESSION['msg']="user is accepted successfully !!";
			  }
		  }
			  ...
			  $sql=mysqli_query($con,"Update users set login_status='$login_status' where id='".$uid."'");
			  if($sql){
				  $_SESSION['msg']="user is rejected successfully !!";
			  }
		  }
?>
