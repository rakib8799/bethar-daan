...
$sql=mysqli_query($con,"insert into doctors(specilization,doctorName,address,contactno,docEmail,password) values('$docspecialization','$docname','$docaddress','$doccontactno','$docemail','$password')");
if($sql)
{
...
<div class="form-group">
					...
					<textarea name="clinicaddress" class="form-control"  placeholder="Enter Doctor Room Address" required="true"></textarea>
														</div>
<div class="form-group">
